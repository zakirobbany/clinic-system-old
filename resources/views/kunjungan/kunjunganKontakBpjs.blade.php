                    ...
                    <div class="x_content">
                        <div class="row">
                            ...
                            <div class="col-sm-8 col-md-8 col-xs-8 text-right">
                                <p><a class="btn btn-primary" href="{{ route('perawat.export.kunjungankontakbpjs') }}">Download</a></p>
                            </div>
                            @endrole
                            @role('admin')
                            <div class="col-sm-4 col-md-4 col-xs-4 text-left">
                                <p><a class="btn btn-primary" href="{{ route('admin.export.kunjungankontakbpjs') }}">Download</a></p>
                            </div>
                            @endrole
                            <div class="clearfix"></div>
