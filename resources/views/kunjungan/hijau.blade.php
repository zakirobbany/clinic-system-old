                    ...
                    <div class="x_content">
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-12 col-xs-12 text-right">
                                <p><a class="btn btn-primary" href="{{ route('kunjungan.bulanan.hijau.index') }}">Kunjungan Bulan Ini</a></p>
                            </div>
                            @endrole
                            @role('dokter')
                            <div class="col-sm-12 col-md-12 col-xs-12 text-right">
                                <p><a class="btn btn-primary" href="{{ route('dokter.kunjungan.bulanan.hijau.index') }}">Kunjungan Bulan Ini</a></p>
                            </div>
                            @endrole
                            @role('registrasi')
                            <div class="col-sm-8 col-md-8 col-xs-8 text-right">
                                <p><a class="btn btn-primary" href="{{ route('perawat.kunjungan.bulanan.hijau.index') }}">Kunjungan Bulan Ini</a></p>
                            </div>
                            @endrole
                            <div class="clearfix"></div>
