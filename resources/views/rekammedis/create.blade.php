                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form action="{{ route('perawat-rekammedis.store') }}" class="form-horizontal" method="post">
                                {{ csrf_field() }}
                                    ...
                                    <div class="col-md-5">
                                        <select name="diagnoses[]" class="form-control js-selectize">
                                            @foreach($diagnoses as $diagnosis)
                                                <option value="{{ $diagnosis->id }}" @if (old('diagnoses[]') == $diagnosis->id) selected @endif>
                                                    {{ $diagnosis->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                            ...
                                            <div class="col-md-5">
                                                <select name="obat_id[]" class="form-control js-selectize">
                                                    @foreach($obats as $obat)
                                                        <option class="form-control" value="{{ $obat->id }}">{{ $obat->nama_obat }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
