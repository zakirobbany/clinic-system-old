                    ...
                    <div class="x_content">
                        <div class="row">
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-4 text-left">
                                <p><a class="btn btn-primary" href="{{ route('admin.export.rujukan') }}">Download</a></p>
                            </div>
                            <div class="col-sm-8 col-md-8 col-xs-8 text-right">
                                <p><a class="btn btn-primary" href="{{ route('rujukan.index') }}">Rujukan Hari Ini</a></p>
                            </div>
                            @endrole
                            @role('dokter')
                            <div class="col-sm-12 col-md-12 col-xs-12 text-right">
                                <p><a class="btn btn-primary" href="{{ route('dokter-rujukan.index') }}">Rujukan Bulan Ini</a></p>
                            </div>
                            @endrole
                            @role('registrasi')
                            <div class="col-sm-4 col-md-4 col-xs-4 text-left">
                                <p><a class="btn btn-primary" href="{{ route('perawat.export.rujukan') }}">Download</a></p>
                            </div>
                            <div class="col-sm-8 col-md-8 col-xs-8 text-right">
                                <p><a class="btn btn-primary" href="{{ route('perawat-rujukan.index') }}">Rujukan Bulan Ini</a></p>
                            </div>
                            @endrole
                            <div class="clearfix"></div>
