                    ...
                    <div class="x_content">
                        <div class="row">
                            <div class="col-sm-4 col-md-4 col-xs-4 text-left">
                                <p><a class="btn btn-primary" href="{{ route('poli.create') }}">Tambah Poli</a></p>
                            </div>
                            <div class="clearfix"></div>
                                ...
                                @foreach($polis as $poli)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            {!! Form::model($poli, ['route'=>['poli.destroy', $poli], 'method'=>'delete', 'class'=>'form-inline', 'style'=>'display:inline;']) !!}
